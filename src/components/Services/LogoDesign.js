...
function LogoDesign() {
  return (
    ...
    <Row>
      <Col xl={5} className='text-right'><Container ><img src='img\logo-trans.png'  alt='about-img' className=" text-right img-fluid"></img></Container></Col>
      <Col  xl={7}>
        <Container className='services-title pt-5'>
          <Row>
            <Col xl={12} sm={6}> <div><h1>Get designed your Logo with us</h1></div></Col>
            </Row>
            <Row>
            <Col xl={12}></Col>
            </Row>
