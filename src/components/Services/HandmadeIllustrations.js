...
import './Services.css';
function HandmadeIllustrations() {
  return (
    <section className='services d-flex flex-direction: colum  align-items-center'>
  <Row>
    <Col xl={4} className='text-right'><Container ><img src='img\handmade2.png'  alt='about-img' className=" text-right img-fluid"></img></Container></Col>
    <Col  xl={8}>
      <Container className='services-title'>
        <Row>
          <Col xl={12} sm={6}> <div className=' pb-4 digi-titte'>Get designed Hand made Illustrations with us</div></Col>
          </Row>
          <Row>
          <Col xl={12}></Col>
          </Row>
...
export default HandmadeIllustrations