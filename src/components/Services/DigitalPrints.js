...
import './Services.css';
function DigitalPrints() {
  return (
    <div> <section className='services d-flex flex-direction: colum  align-items-center'>
    <Row>
      <Col xl={5} className='text-right'><Container ><img src='img\2.png'  alt='about-img' className=" text-right img-fluid"></img></Container></Col>
      <Col  xl={7}>
        <Container className='services-title pt-4'>
          <Row>
            <Col xl={12} sm={6}> <div><h1>Get designed Digital Prints with us</h1></div></Col>
            </Row>
            <Row>
            <Col xl={12}></Col>
            </Row>
