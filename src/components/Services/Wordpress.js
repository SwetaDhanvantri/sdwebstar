...
function Wordpress() {
  return (
    ...
    <Row>
      <Col xl={5} className='text-right'><Container ><img src='img\Design team-pana.png'  alt='about-img' className=" text-right img-fluid"></img></Container></Col>
      <Col  xl={7}>
        <Container className='services-title'>
          <Row>
            <Col xl={12} sm={6}  className=''> <div className=' pb-5 digi-titte'>Get ready your Wordpress website with us</div></Col>
            </Row>
            <Row>
            <Col xl={12}></Col>
            </Row>
